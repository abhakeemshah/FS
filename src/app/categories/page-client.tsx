...
const buildCategoriesFromSnapshot = (snapshot: CatalogSnapshot) =>
  mergeCatalog(
...
export default function CategoriesPage({ initialCatalogSnapshot }: { initialCatalogSnapshot: CatalogSnapshot }) {
