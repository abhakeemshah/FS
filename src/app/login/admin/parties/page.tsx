		...
		<AdminShell active="parties" title="Parties">
			<section className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
				...
				<div className="grid gap-3 p-4 sm:grid-cols-2">
					<Link href="/access/admin/parties/customers" className="rounded-xl border border-blue-200 bg-blue-50 px-4 py-5 text-left shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-blue-100">
					...
					<Link href="/access/admin/parties/suppliers" className="rounded-xl border border-rose-200 bg-rose-50 px-4 py-5 text-left shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-rose-100">
