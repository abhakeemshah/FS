        ...
        <div className="flex-1 min-w-0 overflow-y-auto bg-white px-4 py-4 sm:px-6 sm:py-5 lg:px-8 lg:py-6">
          <div className="mx-auto grid w-full min-w-0 gap-5 max-w-full" id="featured">
            <div className="min-w-0 space-y-5">
              <section className="relative overflow-hidden rounded-[18px] min-h-[220px] sm:min-h-[280px] lg:min-h-[350px] xl:min-h-[410px]" style={{ backgroundColor: heroSettings.backgroundColor }}>
                <img
                ...
                />
                <div className="relative z-20 flex min-h-[220px] items-center px-5 py-4 sm:min-h-[280px] sm:px-8 sm:py-6 lg:min-h-[350px] lg:px-10 lg:py-7 xl:min-h-[410px]">
